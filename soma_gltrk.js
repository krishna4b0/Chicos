/**
 * gltrk.js - v16.06.16.1130.SOMA-KV
 *
...
try {
    var currencyKode = '';
    if (pageType == 'hangonsloopysloopyhangon') {
...
try { var CSACCOUNTID = 4024956 || "NOCSACCOUNTID"; } catch (err) { console.log("Possible error detected in gltrk.js (note: this error does not affect page load and is for informational purposes only) - CSACCOUNTID =*USA*= ",err.message); }
...
try
{
    ...
    if (isHomePage > 1) {
        document.write('\x3Cscript SRC="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Homepage&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
    } //end if
} //end try
catch (err)
{
...
try
{
    if (pageType == "SHELF") {
        switch(glCatId)
        {
            case "cat20002":
                //New Arrivals
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=New_Arrivals&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat40089":
                //Bra
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Bra&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat5969283":
                //vanishing back
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Bra_Vanishing_Back&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat7679281":
                //Embraceable
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Bra_Embraceable&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat8589275":
                //Stunning Support
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Bra_Stunning_Support&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat3310016":
                //Full Coverage
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Bra_Full_Coverage&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat40090":
                //Panties
                //top category (PANTIES)
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Panties&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat5879297":
                //High Leg
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Panties_HighLeg&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat4629277":
                //Hipsters
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Panties_Hipsters&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat20004":
                //Vanishing Edge
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Vanishing_Edge&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat5039300":
                //Clothing
                //top category (CLOTHING)
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Clothing&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat8739276":
                //Dresses
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Clothing_Dresses&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat40092":
                //Sleepwear
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Sleepwear&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat2060003":
                //Swim
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Swim&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat8589275":
                //Stunning Support top level catID (prelaunch?)
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Bra_Stunning_Support&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat40091":
                //Shape
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Shape&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat6079275":
                //Beauty
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Beauty&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "Sale":
                //Beauty
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Sale&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;

            case "cat10549279":
                //Gifts
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Gifts&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
...
try
{
    if (pageType == "PAGE") {
        switch(pageId)
        {
            case "98":
                //Email Signup
                document.write('\x3Cscript src="https://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Email_Sign_Up&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "86409276":
                //Stunning Support
                document.write('\x3Cscript src="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Bra_Stunning_Support&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
...
{
    if (pageType == "CART") {
        document.write('\x3Cscript SRC="http://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Shopping_Cart&revenue=' + cartSubTotal + '&random=CACHEBUSTER">\x3C/script>');
    } //end if
} //end try
catch (err)
{
...
{
    if (pageType == "ORDER") {
        document.write('\x3Cscript SRC="https://webmedia.soma.com/jpixel?spacedesc=9553981_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Soma_&event=Check_Out&revenue=' + checkOutSubTotal + '&random=' + CACHEBUSTER + '&x_order_id=' + checkOutOrderID + '&x_uid=USERID">\x3C/script>');
    } //end if
} //end try
catch (err)
{
...
try
{
    (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
        j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-NHFR8Q');
}//end try
catch (err)
{
    console.log("Possible error detected in gltrk.js (note: this error does not affect page load and is for informational purposes only) - GOOGLE SOMA TAG =*USA*= ",err.message);
} //end catch
...
var Struq = {
    ...
    trackingId:{
        homePage:'cwNvm7m0CUGWfkSqqmHC4A',
        pdp: 'j-6fUzRKxkm2MHmL9j9onA',
        shelf: '6YPXWEPwM0CRoJKn9CDtlg',
        cart: 'Nk98HmPYSk26PspEjmGBEw',
        orderConfirm: '0gLQogZoUkiqIw8_rsHxPA'
    }
}
...
try
{
    if (pageType == "ORDER") {
        if(thisPageProtocol == "https:") {
            document.write('<img src="https://954248.r.msn.com/?dedup=1&domainId=954248&type=1&revenue=' + checkOutSubTotal + '&actionid=92416" frameborder="0" scrolling="no" width="1" height="1" style="visibility:hidden;display:none">');
        } else {
            document.write('<img src="http://954248.r.msn.com/?dedup=1&domainId=954248&type=1&revenue=' + checkOutSubTotal + '&actionid=92416" frameborder="0" scrolling="no" width="1" height="1" style="visibility:hidden;display:none">');
        }
    } // end if
} // end try
catch (err)
...
try {
    if (pageType == "ORDER") {
        ...
        CJ.config = {
            ...
            CID: '1528036',
            BASE_URL_TEMPLATE: 'https://{0}/u?CID={1}&OID={2}&TYPE=362534{3}&CURRENCY=USD&METHOD=IMG',
...
try
{
    if (pageType == "ORDER") {
        // NEW facebook tag
        var fb_param = {};
        fb_param.pixel_id = '6011970461051';
...
try {
    ...
    T2P.config = {
        DOMAIN: 'email.soma.com',
        CHEETAH_ID: 'r2083411311.2093601622',
        BASE_URL_TEMPLATE: 'https://{0}/a/{1}/soma.gif?{2}',
    ...
    function magicTwitter() {
        if (pageType == "ORDER") {
            if (typeof twttr != "undefined") {
                twttr.conversion.trackPid('l4gal', { tw_sale_amount: ttr_saleAmount, tw_order_quantity: numberOfOrderItems });
            }
        } else {
            if (typeof twttr != "undefined") {
                twttr.conversion.trackPid('l4gam');
            }
        }
    }
} catch (err) {
...
try {
    if (pageType != "ORDER") {
        ...
        _fbq.push(['addPixelId', '1378350289106198']);
...
if (pageType == "ORDER") {
    ...
    (function(i,s,o,g,r,a,m){i[r]=i[r]||function(){ (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o), m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m) })(window,document,"script","//dnmpbe216ptzf.cloudfront.net/soma/fitpredictor.js","ssp");

    var numberOfFitPredictorItems = orderConfirmation.items.length;

    for (i = 0; i < numberOfFitPredictorItems; i++) {

        var fp_id = orderConfirmation.items[i].designSku;
        var fp_productId = orderConfirmation.items[i].style;
        var fp_variation = "";
...
try {
    ...
    })(window, document, 'script', 'yuggkwdq.micpn.com', 'mitr');
...
try 
{
  ...
  if(window.location.href.indexOf("orderConfirmation.jsp") > -1) {
       document.write('<img height="1" width="1" alt="" src="https://ct.pinterest.com/?tid=VFzCCTd82cH"/>');
    }
